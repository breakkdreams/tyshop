...
-- 数据库: `zycms`
--
CREATE DATABASE IF NOT EXISTS `zycms` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `zycms`;
...
(1, '默认站点', '', 'http://localhost/zycms/', 'PHPCMS演示站', 'PHPCMS演示站', 'PHPCMS演示站', '', 'default', 'default', 'array (\n  ''upload_maxsize'' => ''2048'',\n  ''upload_allowext'' => ''jpg|jpeg|gif|bmp|png|doc|docx|xls|xlsx|ppt|pptx|pdf|txt|rar|zip|swf'',\n  ''watermark_enable'' => ''1'',\n  ''watermark_minwidth'' => ''300'',\n  ''watermark_minheight'' => ''300'',\n  ''watermark_img'' => ''/statics/images/water/mark.png'',\n  ''watermark_pct'' => ''85'',\n  ''watermark_quality'' => ''80'',\n  ''watermark_pos'' => ''9'',\n)', '980c65dd-3d2b-11e7-8fef-9c5c8e7bb5ef');
...
(1, 'phpcms_v9', 'phpcms v9', 'http://localhost/zycms/', 'waYgbkwnSSFmgfkgGsfhQFdi0CSqCFKg', '', 'api.php?op=phpsso', 'utf-8', 1);
