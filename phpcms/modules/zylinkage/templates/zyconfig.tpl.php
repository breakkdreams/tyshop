...
?>
<link rel="stylesheet" type="text/css" href="<?php echo APP_PATH?>statics/zylinkage/layui/css/layui.css">
<script src="<?php echo APP_PATH?>statics/zylinkage/layui/layui.all.js"></script>

<div class="pad_10">
    <div class="table-list">
        <form name="myform" id="myform" action="?m=zylinkage&c=zylinkage&a=configdel" method="post" onsubmit="checkuid();return false;" >
            <div class="table-list">
                    ...
                    ?>
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <a href="javascript:confirmurl('?m=zylinkage&c=zylinkage&a=configdel&id=<?php echo $r['id'] ?>', '确定删除')"
...
function edit(id) 
{
	...
	{
        id:'edit',
        iframe:'?m=zylinkage&c=zylinkage&a=configedit&id='+id,
        title:'配置信息',
        width:'800',
        height:'265',
        lock:true
...
function show(id) 
{
	...
	{
        id:'show',
        iframe:'?m=zylinkage&c=zylinkage&a=configeditD&id='+id,
        title:'配置详情',
        width:'1000',
