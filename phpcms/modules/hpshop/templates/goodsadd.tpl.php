...
<div class="common-form">
	<div id="div_setting_2" class="contentList">
                    ...
                    <td>
                        <select name="shopid" required="required" >
                            ...
                            if(is_array($minfo)){
                                foreach($minfo as $v){
                                    ?>
                                    <option value="<?php echo $v['userid'] ;?>"><?php echo $v['nickname'] ;?></option>
                                    <?php
                                }
                            }
                            ?>
                    ...
                    <td>
                        <select name="template_id" required="required" >
                            ...
                            if(is_array($fnfos)){
                                foreach($fnfos as $v){
                                    ?>
                                    <option value="<?php echo $v['template_id'] ;?>"><?php echo $v['template_name'] ;?></option>
                                    <?php
                                }
                            }
                            ?>
		...
		d.uploadfile();return false;}, function(){window.top.art.dialog({id:'crop'}).close()});
				...
				<tr>
					<th width="125">市场价</th>  
					<td><input type="number" name="mprice" class="input-text" required="required"/></td>
				</tr>
				<tr>
					<th width="125">本店价</th>  
					<td><input type="number" name="sprice" class="input-text" required="required"/></td>
				</tr>
                <tr>
                    <th width="125">积分价</th>
                    <td><input type="number" name="scoreprice" class="input-text" required="required"/></td>
                </tr>
				<tr>
					<th width="125">总库存</th>  
					<td><input type="number" name="stock" class="input-text" value="100"/><span> （若填写了商品规格则可不填）</span></td>
				</tr>

                <tr>
                    <th width="125">重量</th>
                    <td><input type="number" name="weight" class="input-text" value="0"/><span> （单位:g）</span></td>
                </tr>

                <tr>
                    <th width="125">体积</th>
                    <td><input type="number" name="volume" class="input-text" value="0"/><span> （单位:m³）</span></td>
                </tr>
				...
				<tr>
					...
					<td>
                        ...
                        <textarea name="content" id="content" boxid="content"></textarea>
...
<script type="text/javascript">
            ...
            success:function(data){
                ...
                if(data.spec != 0){
                    ...
                    for(var i=0; i<data.spec.length; i++){
                        ...
                        // html+='<td><span onclick="addCurrentRow(this)">[+]</span><span onclick="addrow(this)">[-]</span></td>';
    ...
    function addCurrentRow(o)
    {
        var tb = document.getElementById("mytable");
        var newTr = tb.insertRow(o);//添加新行，trIndex就是要添加的位置
