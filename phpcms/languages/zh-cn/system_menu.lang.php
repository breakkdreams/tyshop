...
$LANG['zyaddrconfig'] = '地址配置';
$LANG['zylinkage'] = '联动菜单';
$LANG['zyaddr_linkage'] = '联动菜单配置';
...
$LANG['kd_code'] = '快递公司管理';
$LANG['ishop'] = '商品管理';
$LANG['ishop_category'] = '类别管理';
$LANG['ishop_product'] = '商品列表';
$LANG['ishop_order'] = '订单管理';
$LANG['ishop_shipping'] = '物流管理';
$LANG['hpshop'] = '商品管理';
...
$LANG['categorymanage'] = '分类管理';
$LANG['goodstype'] = '商品类型';
$LANG['zyconfigss'] = '商品配置';
$LANG['goodscategory'] = '商品分类';
?>